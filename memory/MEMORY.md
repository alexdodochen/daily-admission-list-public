...
- [Cross-sheet patient search by 病歷號 only — never name](feedback_search_by_chart_no.md) — chart no is the stable unique key; name has Han-variant / OCR-correction risk (added 5/15)
