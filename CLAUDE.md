...
1. **Ordering columns N–T**: 序號 | 主治醫師 | 病人姓名 | 備註 | 術前診斷 | 預計心導管 | 每日續等清單 (user has corrected this multiple times — do not reorder)
...
8. **Skip rule**: 備註含「不排程」→ skip cathlab keyin
...
12. **Waitlist merge**: 續等清單整合 → 有時段醫師接 round-robin、無時段最後，T欄標1
